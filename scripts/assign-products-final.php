<?php
/**
 * Final product assignment - using known category IDs from our previous creation
 */
...
echo "=== Final Product Assignment ===\n\n";

// Category IDs from our previous creation (build-rapax-structure-v2.php output)
...
echo "\n=== Complete! ===\n";
echo "\nTest URLs:\n";
echo "  Main RAPAX: https://ortak.ch/Raven-Weapons/RAPAX/\n";
echo "  RAPAX Sub: https://ortak.ch/Raven-Weapons/RAPAX/RAPAX/\n";
