<?php
/**
 * Shopware Image Uploader for CHF Installation
 * Uploads images to the NEW CHF-based Shopware installation
 */
...
echo "\n";
echo "╔════════════════════════════════════════════════════════════╗\n";
echo "║     SHOPWARE CHF IMAGE UPLOADER                            ║\n";
...
echo "║  Products with no images:       " . str_pad($noImages, 25) . "║\n";
