<?php
/**
 * Fix Order Confirmation Email - NULL-SAFE VERSION
 * Fixes: "Impossible to access an attribute on a null variable" error
 * All object accesses now use null-safe checks
 */

$pdo = new PDO("mysql:host=localhost;dbname=shopware", "root", "root");
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

// German HTML - NULL-SAFE version
$germanHtml = <<<'HTML'
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
    ...
    <div style="padding: 30px 20px;">
        ...
        <!-- Billing Address Only (simplified to avoid null errors) -->
...
// German Plain - NULL-SAFE version
$germanPlain = <<<'PLAIN'
...
echo "\n✅ Order confirmation email template updated with NULL-SAFE version!\n";
echo "All object accesses now use |default() filters and {% if %} checks.\n";
echo "Removed: deliveries.first.shippingOrderAddress (null risk)\n";
echo "Using: order.orderCustomer and order.lineItems (safer)\n";
