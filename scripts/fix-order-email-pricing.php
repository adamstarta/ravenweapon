<?php
/**
 * Fix Order Confirmation Email - Pricing Section
 *
 * Problem: Subtotal showing wrong value (amountNet instead of positionPrice)
 * Solution: Use correct Shopware variables for pricing
 */
...
// Complete fixed HTML template with correct pricing
$htmlContent = <<<'HTML'
...
if ($result) {
    echo "✓ Fixed pricing section!\n";
    echo "  - Zwischensumme: now uses order.price.positionPrice (correct subtotal)\n";
    echo "  - Versand: order.shippingTotal\n";
    echo "  - Gesamtsumme: order.amountTotal\n";
