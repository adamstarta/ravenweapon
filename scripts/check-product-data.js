/**
 * Check product data for Tactical coverall 09F
 */
...
async function main() {
    ...
    const getRes = await httpRequest(CONFIG.apiUrl + '/product/' + productId, {
        method: 'GET',
        headers: { 'Authorization': 'Bearer ' + token }
    });

    console.log('Product data:');
    console.log(JSON.stringify(getRes.data.data, null, 2));
}
